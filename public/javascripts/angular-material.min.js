...
! function(e, t, n) {
  ...
  function() {
    var o = 0;
    t.module("material.core").factory("$mdUtil", ["$cacheFactory", "$document", "$timeout", "$q", "$window", "$mdConstant",
      function(r, i, a, d, c, l) {
        function m(e) {
          return e[0] || e
        }
        var s;
        return s = {
          ...
          disableScrollAround: function(e) {
            function n() {
              ...
              return a.appendChild(d[0]), d.on("wheel", o), d.on("touchmove", o), i.on("keydown", n),
                function() {
            ...
            function o() {
              var e = a.getAttribute("style") || "",
                t = a.scrollTop + a.parentElement.scrollTop;
              return r(a, {
                  position: "fixed",
                  width: "100%",
                  overflowY: "scroll",
  ...
  function() {
    function e(e, n, o, r, i, a) {
      this.compile = function(d) {
        ...
        }), t.extend(u, f), u.$template = c ? n.get(c, {
          cache: a
        }).then(function(e) {
          return e.data
  ...
  function() {
    function e() {
      function e(e) {
        ...
        }), i.$inject = ["$$interimElement", "$animate", "$injector"], l
      }
      ...
      function o(o, r, i) {
        ...
        function m(o, c) {
          function m(e) {
            ...
            return g.unshift(n), E.unshift({
              animating: !0
            }), f.append(n), e && n.css(e), n
          }

          function s(e, t) {
            var n, o, r, a = f.prop("offsetWidth"),
          ...
          return p = h, C.animating = !0, n(function() {
            i.dimBackground && f.css({
              backgroundColor: T
            }), M.addClass("md-ripple-placed md-ripple-scaled"), M.css(i.outline ? {
              borderWidth: .5 * h + "px",
              marginLeft: h * -.5 + "px",
              marginTop: h * -.5 + "px"
            } : {
        ...
        var p, h = r.controller("mdInkRipple") || {},
          b = 0,
          g = [],
          E = [],
          ...
          $ = !1,
          A = r[0],
          C = r.attr("md-ripple-size"),
          T = d(r.attr("md-ink-ripple")) || d(i.colorElement.length && e.getComputedStyle(i.colorElement[0]).color || "rgb(0, 0, 0)");
        switch (C) {
          case "full":
            i.fullRipple = !0;
            break;
          ...
          function c(t) {
            if (t.pointer.distanceY > 0 && (t.pointer.distanceY > 20 || Math.abs(t.pointer.velocityY) > o)) {
              var r = e.prop("offsetHeight") - t.pointer.distanceY,
                i = Math.min(r / t.pointer.velocityY * .75, 500);
    ...
    function n(e) {
      ...
      function o(e, n, o, r, i, a, d, c, l, m, s) {
        ...
        function f(e, m, s) {
          ...
          var p = f();
          if (s.hasBackdrop) {
            var b = s.parent[0] == n[0].body && n[0].documentElement && n[0].documentElement.scrollTop ? t.element(n[0].documentElement) : s.parent,
              v = b.prop("scrollTop");
        ...
        function M(e, t) {
          if (t) {
            var n = t[0].getBoundingClientRect(),
              ...
              i = Math.min(.5, n.width / o.width),
              a = Math.min(.5, n.height / o.height);
    ...
    function e(e, o, r, i) {
      function a(n, a, d, c) {
        ...
        var C = t.bind(c, c.invalidateLayout),
          T = l();
        n.$on("$destroy", m);
        var y, k = e.startSymbol(),
          w = e.endSymbol(),
          x = e(f("share") + "% - (" + f("gutter") + " * " + f("gutterShare") + ")"),
          N = e("calc((" + f("unit") + " + " + f("gutter") + ") * " + f("offset") + ")"),
          _ = e("calc((" + f("unit") + ") * " + f("span") + " + (" + f("span") + " - 1) * " + f("gutter") + ")")
      }
      return {
        restrict: "E",
        controller: n,
    ...
    function e(e) {
      function o(e, o, i, a, d, c, l) {
        function m(n, r, l) {
          ...
          return m(l), a.inherit(l.menuContentEl, l.target), u(), l.disableParentScroll && (l.restoreScroll = i.disableScrollAround(l.element)), d(h, 75, !1), l.backdrop && (a.inherit(l.backdrop, l.parent), l.parent.append(l.backdrop)), f(), i.transitionEndPromise(r, {
            timeout: 350
          })
        }
        ...
        function s(e, t, n, o) {
          for (var r = i.getClosest(e.target, "MD-MENU-ITEM"), a = i.nodesToArray(t[0].children), d = a.indexOf(r), c = d + o; c >= 0 && c < a.length; c += o) {
            var l = a[c].firstElementChild || a[c],
              m = u(l);
            if (m) break
          }
        }
        ...
        function f(e, r, a) {
          return a.isRemoved = !0, r.addClass("md-leave").removeClass("md-clickable"), t.element(o).off("resize", a.resizeFn), t.element(o).off("orientationchange", a.resizeFn), a.resizeFn = n, i.transitionEndPromise(r, {
            timeout: 350
          }).then(function() {
        ...
        function p(e, t) {
          ...
          if (!t.isRemoved) {
            var o, i, a, d = e[0],
              l = e[0].firstElementChild,
              m = l.getBoundingClientRect(),
              s = t.parent[0],
              u = s.getBoundingClientRect(),
              f = t.target[0].querySelector("[md-menu-origin]") || t.target[0],
    ...
    function a(e) {
      function o(e, o, a, c, l, m, s) {
        ...
        function f(e, o, r) {
          ...
          return i && i.setLabelText(r.selectEl.controller("mdSelectMenu").selectedLabels()), c.transitionEndPromise(o, {
            timeout: 350
          }).then(function() {
  ...
  function() {
    function e(e, n, o, r, i, a, d, c) {
      ...
      function m(o, l, m, s) {
        ...
        var L = m.ngDisabled && c(m.ngDisabled),
          P = L ? function() {
            return L(o.$parent)
          } : t.noop,
          F = t.element(l[0].querySelector(".md-thumb")),
          j = t.element(l[0].querySelector(".md-thumb-text")),
          B = F.parent(),
          q = t.element(l[0].querySelector(".md-track-container")),
          V = t.element(l[0].querySelector(".md-track-fill")),
          U = t.element(l[0].querySelector(".md-track-ticks")),
          Y = r.throttle(E, 5e3);
    ...
    function e(e, o, r, i, a) {
      function d(e) {
        function t(e, t) {
          ...
          return h.items.push(n), f.parent().prepend(n.clone), p(),
            function() {
        ...
        function r() {
          ...
          for (var e, t = f.prop("scrollTop"), n = h.items.length - 1; n >= 0; n--)
            if (t > h.items[n].top) {
              e = h.items[n];
              break
            }
  ...
  function() {
    function e(e, n, o, r, i, a, d, c, l) {
      function m(m, f, p) {
        ...
        function w() {
          function e() {
            var e = "left" === H || "right" === H ? 2 * Math.sqrt(Math.pow(o.width, 2) + Math.pow(o.height / 2, 2)) : 2 * Math.sqrt(Math.pow(o.width / 2, 2) + Math.pow(o.height, 2)),
              t = "left" === H ? {
                left: 100,
                top: 50
              } : "right" === H ? {
        ...
        var x = M(),
          ...
          _ = t.element(f[0].getElementsByClassName("md-content")[0]),
          H = p.mdDirection,
          S = $(),
          I = t.element(S || document.body),
          O = o.throttle(function() {
            m.visible && w()
          });
        return h()
      }
    ...
    function e(e, n, i, a, d, c, l, m, s, u) {
      ...
      function p() {
        ...
        var t = Z.wrap.getBoundingClientRect(),
          ...
          i = Z.root.getBoundingClientRect(),
          a = n.bottom - i.top,
          c = i.bottom - n.top,
          l = t.left - i.left,
          m = t.width,
      ...
      function N(e) {
        var t = ne.indexOf(e); - 1 != t && ne.splice(t, 1)
      }
      ...
      function V() {
        ...
        t.initCustomEvent("input", !0, !0, {
          value: e.searchText
        }), Z.input.dispatchEvent(t), Z.input.focus()
      }
    ...
    function e(e, t, a, d, c) {
      function l(n, l) {
        ...
        var u = m("md-chips>*[md-chip-remove]") || i,
          f = m("md-chips>md-chip-template") || r,
          p = m("md-chips>md-autocomplete") || m("md-chips>input") || o,
          h = s.find("md-chip");
    ...
    function e() {
      ...
      return {
        ...
        template: function(e, t) {
          ...
          function o() {
            var n = e.find("md-tab-body").eq(0),
              o = n.length ? n.html() : t.label ? e.html() : "";
  ...
  function() {
    function e(e, n, o, r, i, a, d, c, l, m, s) {
      ...
      function y() {
        var e, t, n = J.canvas.clientWidth,
          o = n + Q.offsetLeft;
      ...
      function x(t) {
        var n = e.selectedIndex,
          o = Q.tabs.splice(t.getIndex(), 1)[0];
      ...
      function K() {
        ...
        var t = J.contents[e.selectedIndex],
          o = t ? t.offsetHeight : 0,
          r = J.wrapper.offsetHeight,
          i = o + r,
      ...
      function X(e, n) {
        var o = {
          colorElement: t.element(J.inkBar)
        };
        a.attach(e, n, o)
      }
      var Q = this,
